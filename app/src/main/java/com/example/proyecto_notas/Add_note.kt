        ...
        binding.btnNext.setOnClickListener{view : View ->
            if(txt_title!!.length()>0){
                ...
                if(sp_note_type.selectedItemId.toString().equals("1")){
                    ...
                    Toast.makeText(activity, "Elige un tipo de nota", Toast.LENGTH_SHORT).show()
                }

            }else{
                Toast.makeText(activity, "Agrega un título", Toast.LENGTH_SHORT).show()
